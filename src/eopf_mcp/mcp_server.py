    ...
    try:
        ...
        if name == "list_collections":
            ...
            if has_non_l2a and collections:
                result["visualization_warning"] = " X - IMPORTANT: Only Sentinel-2 L2A products support visualization in map interfaces. Sentinel-1, Sentinel-3, and Sentinel-2 L1C products cannot be visualized with Titiler."
            ...
            while(1==1):
                for item in items:
                    ...
                    print("Vous n'avez pas dit le mot magique !!!")
